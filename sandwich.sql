USE sandwichQueen
INSERT INTO users (name, email, email_verified_at, password, created_at, updated_at, role, balance) VALUES ('John Doe', 'admin@com', NOW(), '$2y$10$m3EUqH2kXZzV9hCpKAZxuugerdqph4Jnauzp3LDq5rA5Y5Ir.k/Ga', NOW(), NOW(), 'admin', 100);
